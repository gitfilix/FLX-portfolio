...
const AboutMe = () => {
    return (
        <div className='min-h-screen px-96 flex flex-col items-center justify-center' id='aboutme'>
            ...
            <div className='w-full max-w-6xl flex flex-col md:flex-row md:px-6 items-center md:items-start justify-between gap-8 md:gap-12'>
                <Image
                    ...
                    className='w-[200px] sm:w-[400px] md:w-72 lg:w-80 h-auto rounded-lg'
                />
                <div className="w-full max-w-[800px] bg-transparent md:px-6 text-justify transition-colors">
                    {/* <span className="absolute -left-5 top-20 scale-[2.5] text-zinc-100 md:hidden dark:text-zinc-700 transition-colors">
                        {arrowLeftIcon}
                    </span> */}
                    <p className="text-sm sm:text-1xl md:text-2xl md:my-[-5px] font-light text-amber-200 first-letter:pl-3">
                        {aboutText}
                    </p>
                    <a
                        href="/my-cv.pdf"
